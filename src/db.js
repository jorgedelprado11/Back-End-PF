...
//   `mysql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}/${POSTGRES_DATABASE}`,
...
Products.hasMany(Comments, { foreignKey: "id_producto" });
Comments.belongsTo(Products, { foreignKey: "id_producto" });
